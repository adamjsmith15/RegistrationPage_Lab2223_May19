...
.container .line {
	...
	width: 1px;
	height: 0px;
	background-image: -webkit-gradient(linear, 50% 0%, 50% 100%, color-stop(0%, #F0C27B),
		color-stop(100%, #4B1248));
...
<body>
	<!-- for the bubble animations in the background -->
	...
	<!--  does the animation with "Hello" and then the first name of the new member -->
	<div class="container">
	...
	<!-- runs scripts for the animation -->
	<script
	...
	<!-- runs local java script for the animation -->
